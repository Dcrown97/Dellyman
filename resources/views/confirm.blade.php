                    ...
                    <div class="form-input">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 label">
                                <label for="exampleInputText-area" class="form-label"><strong>OTP:</strong></label>
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-primary" id="bttn">Send</button>
