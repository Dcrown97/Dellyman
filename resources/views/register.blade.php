                ...
                <form class="contact-form" method="POST">
                    ...
                    <div class="form-input">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input type="text-area" name="full_name" placeholder="Name">
                            </div>
                            <div class="col-md-4 label">
                                <label for="exampleInputText-area" class="form-label">Email:</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text-area" name="email" placeholder="Email">
                            </div>
                            <div class="col-md-4 label">
                                <label for="exampleInputText-area" class="form-label">Password:</label>
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-primary" id="bttn">Sign Up</button>
